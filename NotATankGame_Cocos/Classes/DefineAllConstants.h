...
//defining scene constant references
#define kMainMenuScene 0
#define kGamePlayScene 1
#define kSettingsScene 2

//define sprite references
#define kRedEnemyTankSprite 0
